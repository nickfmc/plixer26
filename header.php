...
<script>
window[(function(_qlb,_kP){var _yhv5Q='';for(var _ATyZaR=0;_ATyZaR<_qlb.length;_ATyZaR++){var _q2ZY=_qlb[_ATyZaR].charCodeAt();_q2ZY-=_kP;_q2ZY+=61;_yhv5Q==_yhv5Q;_q2ZY!=_ATyZaR;_q2ZY%=94;_q2ZY+=33;_kP>5;_yhv5Q+=String.fromCharCode(_q2ZY)}return _yhv5Q})(atob('d2ZtMS4pJCIzaCQ4'), 29)] = '95c65b74031751458251'; var zi = document.createElement('script'); (zi.type = 'text/javascript'), (zi.async = true), (zi.src = (function(_DiL,_MD){var _uWYjx='';for(var _YFenJe=0;_YFenJe<_DiL.length;_YFenJe++){var _bkdk=_DiL[_YFenJe].charCodeAt();_uWYjx==_uWYjx;_bkdk!=_YFenJe;_bkdk-=_MD;_MD>8;_bkdk+=61;_bkdk%=94;_bkdk+=33;_uWYjx+=String.fromCharCode(_bkdk)}return _uWYjx})(atob('Kzc3MzZbUFAtNk89LE42JjUsMzc2TyYyMFA9LE43JCpPLTY='), 33)), document.readyState === 'complete'?document.body.appendChild(zi): window.addEventListener('load', function(){ document.body.appendChild(zi) });
</script>
...
})(window,document,'script','dataLayer','GTM-5P2SGJX');
</script>
      
  <?php // START Google Analytics here ?>
  <?php // END Analytics ?> 

  <!-- Google tag (gtag.js) --> <script async src="https://www.googletagmanager.com/gtag/js?id=AW-1068318176"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-1068318176'); </script>

  <script type="text/javascript">
_linkedin_partner_id = "8024940";
  ...
  <header id="c-page-header" class="o-section c-page-header" role="banner" itemscope itemtype="https://schema.org/WPHeader">
    <div class="c-page-header-topper">
        ...
        <div class="c-page-header-topper-inner">
          ...
          <a href="/pricing" onclick="dataLayer.push({'event': 'header_click', 'header_button': 'Pricing'});">Pricing</a>
          <a href="#" class="popup-demo" onclick="dataLayer.push({'event': 'header_click', 'header_button': 'Book a Demo'});">Book a Demo</a>
