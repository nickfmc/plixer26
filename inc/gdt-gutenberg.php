...
function maw_register_guten_script() {
  wp_register_script( 'splide', get_template_directory_uri() .'/dist/splide.min.js', [ 'acf' ]);
  wp_register_script( 'splidescroll', get_template_directory_uri() .'/dist/splide-extension-auto-scroll.min.js', [ 'splide' , 'acf' ]);
...
function register_acf_blocks() { 
  ...
  register_block_type(  get_stylesheet_directory() . '/template-part/block/divider/block.json' );
  ...
  register_block_type(  get_stylesheet_directory() . '/template-part/block/pricing-chart/block.json' );
}
